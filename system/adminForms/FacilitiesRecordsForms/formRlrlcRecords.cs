...
{
    public partial class formRlrlcRecords : Form
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        SqlDataAdapter da;
        string facilityType = "rlrc";

        private Form activeForm;
        public formRlrlcRecords()
        {
            InitializeComponent();
        }
        private void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            this.panelRlrlcRecords.Controls.Add(childForm);
            this.panelRlrlcRecords.Tag = childForm;
            childForm.BringToFront();
            childForm.Show();
        }

        private void btnAddRlrl_Click(object sender, EventArgs e)
        {
        ...
        private void panelRlrlcRecords_Paint(object sender, PaintEventArgs e)
        {
