...
{
    public partial class formMainBuildingRecords : Form
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        public formMainBuildingRecords()
        {
            InitializeComponent();
        }
        ...
        private void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            this.panelMainBuildingRecordsTable.Controls.Add(childForm);
            this.panelMainBuildingRecordsTable.Tag = childForm;
        ...
        private void panelMainBuildingRecordsTable_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            cmd = new SqlCommand("Select * From facility where facilityType='main building'", cn);
