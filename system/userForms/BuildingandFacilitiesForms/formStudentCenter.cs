...
{
    public partial class formStudentCenter : Form
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        private void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            this.panelStudentCenterTable.Controls.Add(childForm);
            this.panelStudentCenterTable.Tag = childForm;
        ...
        private void panelStudentCenterTable_Paint(object sender, PaintEventArgs e)
        {
