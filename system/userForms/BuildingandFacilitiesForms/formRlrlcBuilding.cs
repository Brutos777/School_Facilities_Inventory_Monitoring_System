...
namespace system.userForms.BuildingandFacilitiesForms
{
    ...
    public partial class formRlrlcBuilding : Form
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        private void OpenChildForm(Form childForm, object btnSender)
        {
            ...
            this.panelRlrlcBuildingTable.Controls.Add(childForm);
            this.panelRlrlcBuildingTable.Tag = childForm;
        ...
        private void panelRlrlcBuildingTable_Paint(object sender, PaintEventArgs e)
        {
